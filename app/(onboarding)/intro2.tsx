...
export default function Intro2Screen() {
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <ThemedText type="title" style={styles.title}>Bitkilerinizi Kaydedin</ThemedText>
      <ThemedText type="subtitle" style={styles.subtitle}>Bitkilerinizin türünü, sulama sıklığını ve daha fazlasını kaydedin.</ThemedText>
      <TouchableOpacity
